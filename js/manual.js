const manual = {
    ...
    21: {
        ...
        content: '<p>Drücken Sie auf die Taste, um die Pressform aufzufahren.</p><img src="../static/img/pressform.jpg" alt="Pressform">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    22: {
        ...
        content: '<p>Drücken Sie auf die Taste zweimal, um die Ausspritzautomatik des Aggregats zu starten.</p><img src="../static/img/ausspritzautomatik.jpg" alt="Ausspritzautomatik">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    24: {
        ...
        content: '<p>Drücken Sie auf die Taste, um das Aggregat zu verfahren.</p><p>Dies ermöglicht ein Stück Pappe unterhalb des Aggregates zu legen, um Materialreste aufzufangen.</p><img src="../static/img/aggregat.jpg" alt="Aggregat">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    26: {
        ...
        content: '<p>Stellen Sie die Dosierung auf 140 durch Drücken der Taste.</p><img src="../static/img/dosierung.jpg" alt="Dosierung">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    27: {
        ...
        content: '<p>Drücken Sie die Taste, um die Produktion zu starten.</p><img src="../static/img/produktion.jpg" alt="Produktion">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    28: {
        ...
        marker: 'Cup',
        title: 'Start drücken',
        content: '<p>Drücken Sie die <img class="inline" src="static/img/I.png" alt="I">-Taste, die Applikation auf dem Touchscreen leuchtet orange.</p><img src="../static/img/start.jpg" alt="Start">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    29: {
        ...
        content: '<p>Drücken Sie die Taste "Zyklus-Ende", um die Produktion wieder zu stoppen, da vorerst nur Ausschuss produziert wird.</p><p>Die Maschine wird unvollständige Becher produzieren.</p><img src="../static/img/zyklus.jpg" alt="Zyklus">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
    ...
    30: {
        ...
        content: '<p>Drücken Sie die Taste, um die Automatik auszuschalten.</p><img src="../static/img/produktion.jpg" alt="Produktion">',
        height: 1,
        width: 1,
        xpos: 0,
        ypos: 0,
